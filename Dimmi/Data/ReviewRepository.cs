...
namespace Dimmi.Data
{
    public class ReviewRepository : IReviewRepository
    {
        ...
        public Review Add(Review review)
        {
            ...
            newR.id = newId;
            _reviewRepository.Collection.Insert(newR);
            _rr.UpdateStatistics(newR.parentReviewableId);
            return Get(newId);
        }
        ...
        public IEnumerable<Review> GetByReviewableId(Guid reviewableId)
        {
            ...
            var result = _reviewRepository.Collection.Find(query);
        ...
        public IEnumerable<Review> GetByIdByOwner(Guid reviewableId, Guid userId)
        {
        ...
        public IEnumerable<Review> GetByReviewType(string type, Guid userId)
        {
        ...
        {
            var result = _reviewRepository.Collection.FindAllAs<ReviewData>();
            List<Review> output = new List<Review>();
            foreach (ReviewData rd in result)
            {
                Review newR = CopyFromDataToModel(rd);
        ...
        public Review Update(Review review)
        {
            ...
            _reviewRepository.Collection.Save(newR);
            _rr.UpdateStatistics(newR.parentReviewableId);
            return Get(newR.id);
        }
